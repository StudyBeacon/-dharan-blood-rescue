...
const Header = ({
  ...
  return (
    <header className="max-w-7xl mx-auto bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 transition-colors duration-300">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-80 max-h-96 overflow-y-auto dark:bg-gray-800 dark:border-gray-700"
              >
                  ...
                  <div className="space-y-2">
                    <div className="p-3 bg-red-50 dark:bg-red-950 rounded-lg">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-300">
                        O+ blood needed at Dharan Hospital
                      </p>
            ...
            <DropdownMenu>
              ...
              >
                <DropdownMenuItem
                  onClick={() =>
                    onLanguageChange(currentLanguage === "en" ? "ne" : "en")
                  }
                >
